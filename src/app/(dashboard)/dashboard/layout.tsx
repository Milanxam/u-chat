            ...
            <div className='hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-300 50 px-6'>
                ...
                <nav className='flex flex-1 flex-col'>
                    <ul role='list' className='flex flex-1 flex-col gap-y-3 text-gray-900 bg-gray-50'>
                        ...
                        <ul role='list' className='-mx-2 mt-1 space-y-3 bg-gray-50 rounded-xl p-3'>
                            {sideBarOptions.map((option) => {
                                ...
                                return(
                                    <li key={option.id}>
                                        <Link 
                                            href={option.href}
                                            className='text-gray-700 hover:bg-white hover:text-indigo-600 group flex gap-3 rounded-xl p-3 m-y-10 text-sm leading-6 font-semibold'>
                        ...
                        <li className='-mx-6 mt-auto flex items-center mb-5'>
                            ...
                            <SignOutButton className='h-full aspect-square rounded-2xl mr-5' />
                        </li>
                    </ul>
                </nav>
            </div>
            <aside className='max-h-screen container w-full pb-1 pt-8 md:py-8'>{children}</aside>
        </div>
    )
}
